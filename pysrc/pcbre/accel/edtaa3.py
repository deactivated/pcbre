...
compute_gradient.argtypes = [
    c_double_p, ctypes.c_int, ctypes.c_int, c_double_p, c_double_p]
compute_gradient.restype = ctypes.c_void_p

edtaa3 = dll.edtaa3
edtaa3.argtypes = [c_double_p, c_double_p, c_double_p,
                   ctypes.c_int, ctypes.c_int, c_short_p, c_short_p, c_double_p]
