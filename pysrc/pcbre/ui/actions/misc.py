...
class NudgeLeftAction(QtGui.QAction):
    ...
    def __init__(self, window):
        QtGui.QAction.__init__(self, "nudge left", window,
                               triggered=lambda: _nudge(-1, 0))
...
class NudgeRightAction(QtGui.QAction):
    ...
    def __init__(self, window):
        QtGui.QAction.__init__(self, "nudge right", window,
                               triggered=lambda: _nudge(1, 0))
...
class NudgeUpAction(QtGui.QAction):
    ...
    def __init__(self, window):
        QtGui.QAction.__init__(self, "nudge up", window,
                               triggered=lambda: _nudge(0, -1))
...
class ShowToolSettingsAction(QtGui.QAction):
    ...
    def __init__(self, window):
        QtGui.QAction.__init__(self, "Show tool settings",
                               window, triggered=self.showToolSettings)
