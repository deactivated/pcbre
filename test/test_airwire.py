...
class test_airwire(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.trace_top = Trace(Point2(50, 50), Point2(
            7000, 7000), 10, self.top_layer)
        self.trace_bot = Trace(Point2(7000, 50), Point2(
            50, 7000), 10, self.bottom_layer)
    ...
    def test_basic_join(self):
        airwire = Airwire(Point2(200, 201), Point2(51, 7000),
                          self.top_layer, self.bottom_layer, None)
    ...
    def test_remove_one_ep(self):
        airwire = Airwire(Point2(200, 201), Point2(49, 7000),
                          self.top_layer, self.bottom_layer, None)
        self.p.artwork.merge_artwork(airwire)
    ...
    def test_remove_other_ep(self):
        airwire = Airwire(Point2(200, 201), Point2(50, 7000),
                          self.top_layer, self.bottom_layer, None)
        self.p.artwork.merge_artwork(airwire)
